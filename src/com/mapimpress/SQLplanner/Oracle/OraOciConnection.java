...
public class OraOciConnection implements iConnection {
        ...
        try {
            ...
            try {
                if (oraDBRole.toLowerCase() != "normal") {
                    conn = DriverManager.getConnection("jdbc:oracle:oci8:@" + oraDBName, userName + " as " + oraDBRole, userPass);
                } else {
                    conn = DriverManager.getConnection("jdbc:oracle:oci8:@" + oraDBName, userName, userPass);
                }
